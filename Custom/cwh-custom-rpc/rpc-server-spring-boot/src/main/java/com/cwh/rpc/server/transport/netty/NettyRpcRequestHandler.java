package com.cwh.rpc.server.transport.netty;
...
import com.cwh.rpc.core.enums.MessageStatus;
    ...
    protected void channelRead0(ChannelHandlerContext ctx, RpcMessage msg) throws Exception {
        threadPool.submit(() -> {
            try {
                ...
                MessageType type = MessageTypeUtil.parseByType(header.getMessageType());
