...
import com.cwh.rpc.client.handler.RpcResponseHandler;
import com.cwh.rpc.client.transport.RpcClient;
import com.cwh.rpc.core.codec.RpcFrameDecoder;
import com.cwh.rpc.core.codec.SharableRpcMessageCodec;
        ...
        bootstrap.group(eventLoopGroup)
                ...
                .handler(new ChannelInitializer<NioSocketChannel>() {
                    ...
                    protected void initChannel(NioSocketChannel channel) throws Exception {
                        ...
                        channel.pipeline().addLast(new IdleStateHandler(0, 15, 0, TimeUnit.SECONDS));
                        //用于处理黏包半包 解码器
                        channel.pipeline().addLast(new RpcFrameDecoder());
                        //用于处理编码 解码器
                        channel.pipeline().addLast(new SharableRpcMessageCodec());
                        //用于rpc响应消息处理器
